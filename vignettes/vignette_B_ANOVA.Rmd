...
is treatment coding, but other codings can be specified using the `contrasts`
...
special attributes that would interefere with the estimation of the bull effect,
...
case a random variation over three time-points. 
...
### REML
REML estiamation can be done directly with the lme4 package, but we can also
...
The test statistics are joint for all responses, here in the form of the defaul Pillai's
